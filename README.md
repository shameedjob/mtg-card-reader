...
Card data sourced from [Scryfall](https://scryfall.com/docs/api) via the bulk-data endpoint (`https://api.scryfall.com/bulk-data/`). Multi-color cards are assigned a single color for training via random sampling.
